...
(voting_trends_dependent_abortion)+(voting_trends_dependent_lgbtq)+(voting_trends_dependent_immigration)+(voting_trends_dependent_environment)+(voting_trends_dependent_economy)
```
