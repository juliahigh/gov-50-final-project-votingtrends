...
# Filtering each issue to democrats and republicans (separately) to be able to do regressions!

This table is Democrat views on all issues in general without averages! 
make sure i didn't overwrite anything when renaming variables

will need to rename the race variables
...
INCLUDE a tibble of the averages and name everything 
```{r}
...
Democrat abortion regression below
