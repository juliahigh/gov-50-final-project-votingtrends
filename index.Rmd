---
title: "Gov 50 Final Project: The Interaction Between Partisan and Racial Identities"
author: "Julia High"
description: "An exploration of whether Democrat and Republican views on abortion, LGBTQ+ rights (gay marriage), immigration, the environment, and the economy differ by racial group. This project is significant in light of the United States' rapidly diversifying population. Optimally, research like this will inform politicians that their party bases are not monolithic--their constituents' partisan identities are instead shaped by their racial and cultural backgrounds."
output:
...
Note: I ended up changing my entire project from my milestones because I realized my previous dataset would not have nearly enough information to perform interesting analyses. I think my updated project with my new dataset has revealed far more interesting findings, and I hope you agree!
...
Analysis Plot 1 shows respondents' average views on abortion for each party by racial group and party.  
...
Note: For my regressions, I chose not to analyze the coefficients of multiple races. I was unsure whether analyzing multiple races as a whole would offer "interesting" results because there is no indication of which races respondents are, and I did not want to make this population a monolith.
...
Being a Democrat increases the average views of Hispanic respondents on abortion by 0.867 as compared to Hispanic Republicans, keeping educational level and gender constant. The coefficient for Hispanic Democrats was also statistically significant.
...
Being a Democrat increases the average views of Asian American respondents on abortion by 0.955 as compared to Asian American Republicans, keeping educational level and gender constant. The intercept that depicted Asian American Democrats was statistically significant.
...
modelsummary::modelsummary(abortion_regression_rep,
                           ...
                           coef_rename = c(
                             "(Intercept)" = "Intercept",
                             "race3Black, non-Hispanic" = "Black, non-Hispanic",
                             "race3Hispanic" = "Hispanic",
                             "race3Multiple races" = "Multiple races, non-Hispanic",
                             "race3Native American" = "Native American/Alaska Native or other race, non-Hispanic",
                             "race3White, non-Hispanic" = "White, non-Hispanic",
                             "education_levelAssociate degree in college - vocational" = "Associate's degree in college - vocational",
                             "education_levelBachelor's degree" = "Bachelor's degree",
                             "education_levelHigh school graduate" = "High school graduate",
                             "education_levelLess than high school" = "Less than high school",
...
Being a Republican increases the average views of Black respondents on gay marriage by 0.833 as compared to Black Democrats, keeping educational level and gender constant. The coefficient for Black Democrats was also statistically significant.
...
Being a Republican increases the average views of Asian American respondents on gay marriage by 0.712 as compared to Asian American Democrats, keeping educational level and gender constant. The intercepts that represented Asian American Democrats and Republicans were also statistically significant.
...
Being a Democrat increases the views of Hispanic respondents on immigration by 0.363 as compared to Hispanic Republicans, keeping educational level and gender constant. The coefficient for Hispanic Democrats was statistically significant.

Being a Democrat increases the views of Native American respondents on immigration by 1.093 as compared to Native American Republicans, keeping educational level and gender constant. The coefficient for Native American Democrats was statistically significant.

Being a Democrat increases views of White respondents on immigration by 0.81 as compared to White Republicans, keeping educational level and gender constant. The coefficient for White Democrats was statistically significant.

Being a Democrat increases the views of Asian American respondents on immigration by 0.436 as compared to Asian American Republicans, keeping educational level and gender constant. The intercepts for Asian American Democrats and Republicans were statistically significant.
...
Being a Republican increases the average views of Hispanic respondents on the environment by 2.548 as compared to Hispanic Democrats, keeping educational level and gender constant. The coefficient for Hispanic Democrats was statistically significant.
...
Being a Republican increases the average views of White respondents on the environment by 2.52 as compared to White Democrats, keeping educational level and gender constant. The coefficient for White Democrats was statistically significant.

Being a Republican increases the average views of Asian American respondents on the environment by 1.272 as compared to Asian American Democrats, keeping educational level and gender constant. The intercepts for Asian American Democrats and Republicans were statistically significant.
...
Being a Democrat increases the average views of Black respondents on the economy by 0.949 as compared to Black Republicans, keeping educational level and gender constant. The coefficient for Black Democrats was statistically significant.

Being a Democrat increases the average views of Hispanic respondents on the economy by 1.2 as compared to Hispanic Republicans, keeping educational level and gender constant. The coefficient for Hispanic Democrats was statistically significant.

Being a Democrat increases the average views of Native American respondents on the economy by 1.766 as compared to Native American Republicans, keeping educational level and gender constant. The coefficients for Native American Democrats and Republicans were statistically significant.

Being a Democrat increases the average views of White respondents on the economy by 1.125 as compared to White Republicans, holding educational level and gender constant. The coefficients for White Democrat and Republicans were statistically significant.

Being a Democrat increases the average views of Asian American respondents on the economy by 0.012 as compared to Asian American Republicans, holding educational level and gender constant. The intercepts for Asian American Democrats and Republicans were statistically significant.
...
Overall, my results do show support for my hypothesis, that yes, Democrat and Republican views on 5 major social issues will differ by racial group. All of my regressions shows that responses to key questions on abortion, immigration, gay marriage, the environment, and the economy differed, sometimes significantly between Democrats of a given race and Republicans of that same race.

Despite this, my analysis has multiple limitations and threats to inference. For one, my dataset restricted many of the confounders that would have been useful to consider, like income level, age, and sexuality. Without these factors, and many other possible confounders, I cannot interpret my results causally. Even still, my regressions, some of which were statistically significant, allowed me to definitively recognize that respondents' views on the key issues differed among racial group, at least among the people in this survey. 

A more sophisticated version of this study might include those missing confounding variables, and it might also have a broader sample size. Given that I had to filter my dataset down to include individuals who had responded to my questions of interest, my dataset went from over 8,000 respondents to over 2,000. Perhaps a larger sample size would have afforded more statistical significance and allowed me to generalize my findings into the real world.
